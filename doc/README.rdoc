...
3. There ought not to be a step three :)

== Using Maître D'

I will try to describe the use case I find most imminent:

"An organisation has deployed an intranet using the Rails framework. IT Development builds the app with published gems and inhouse code, which all gets
...
installing and perhaps configuring!
